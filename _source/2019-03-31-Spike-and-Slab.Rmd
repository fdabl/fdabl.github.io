...
p2 <- ggplot() +
  ...
  geom_segment(
    aes(x = 0, y = 0, xend = 0, yend = 0.8, group = 1),
...
ppp <- ggplot(data.frame(x = beta_samples), aes(x = x)) +
  ...
  geom_segment(aes(x=-0.2,xend=0.8,y=-Inf,yend=-Inf))+
  geom_segment(aes(y=0,yend=500,x=-Inf,xend=-Inf))+
  # theme_pubclean() +
  theme(
    axis.line = element_blank(),
    panel.grid.major = element_blank(),
