...
```{r risk plot sensitivity, echo = FALSE, dpi = 400, fig.height = 8}
...
```{r, eval = FALSE, echo = FALSE}
(risks <- party_risk(105, 5 * c(london_cases, barcelona_cases, amsterdam_cases)) * 100)
```
...
```{r, eval = FALSE, echo = FALSE}
(risks <- party_risk(30, 1 * c(london_cases, barcelona_cases, amsterdam_cases)) * 100)
(risks <- party_risk(30, 5 * c(london_cases, barcelona_cases, amsterdam_cases)) * 100)
(risks <- party_risk(30, 10 * c(london_cases, barcelona_cases, amsterdam_cases)) * 100)
```
