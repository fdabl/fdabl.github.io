...
```{r, fig.cap='Fitting a line with only one point (underdetermined).', echo = FALSE, fig.width = 5, fig.height = 5, fig.align = 'left'}
library('ggplot2')
ptheme <- theme(
...
```{r, fig.cap = 'Fitting a line with two points (determined).', echo = FALSE, fig.width = 5, fig.height = 5, fig.align = 'right'}
plot(1, type = "n", xlim = lim, ylim = lim,
...
```{r, fig.cap = 'Fitting lines with three points (overdetermined).', echo = FALSE, fig.width = 5, fig.height = 5, fig.align = 'right'}
plot(1, type = "n", xlim = lim, ylim = lim,
...
<div style= "float: left;">
```{r, fig.cap = 'Fitting a curve with three points', echo = FALSE, fig.width = 5, fig.height = 5, fig.align = 'right'}
y <- c(2, 1, 2)
...
```{r, fig.cap = 'Fitting the line that minimizes the sum of squared errors.', echo = FALSE, fig.width = 5, fig.height = 5, fig.align = 'right', eval = TRUE}
plot(1, type = "n", xlim = lim, ylim = lim,
...
<div style= "float: left; padding: 10px 10px 10px 0px;">
```{r, fig.cap = 'Figure illustrating the geometric insight.', echo = FALSE, fig.width = 5, fig.height = 5, fig.align = 'right', eval = TRUE}
...
<!-- <div style= "float: left; padding: 10px 10px 10px 0px;"> -->
```{r, fig.cap = 'Shows three Normal distributions with different variance.', echo = FALSE, fig.width = 7, fig.height = 6}
# library('rmutil')
# library('ggplot2')
# library('latex2exp')
# 
...
```{r, fig.cap = 'Illustrates the Central Limit Theorem.', fig.align = 'center', fig.width = 8, fig.height = 7}
set.seed(1776)
...
<div style= "float: left; padding: 10px 10px 10px 0px;">
```{r, fig.cap = 'Illustrates that linear regression assumes that the conditional distribution of the response y given the features x is a Gaussian distribution.', echo = FALSE, fig.width = 6, fig.height = 5}
