...
plot_beta <- function(a, b, ylab = 'Density', title = NULL) {
...
plot_beta(1, 2, ylab = '')
plot_beta(2, 2)
plot_beta(10, 10, ylab = '')
plot_beta(0.8, 0.8, ylab = '', title = TeX(sprintf("$a = %.1f,  b = %.1f$", .8, .8)))
```
...
plot_path <- function(y, n, reg, title, ylab = '') {
  ...
  plot(path, ylim = c(0, 1), type = 'l', lty = 1,
       ylab = ylab, xlab = TeX('$\\lambda$'), las = 1, main = title, lwd = 3,
       cex.lab = 1.5, cex.main = 1.5, col = 'skyblue', axes = FALSE)
...
plot_pen_llh <- function(y, n, lambdas, reg = 1, ylab = 'Penalized Likelihood', title = '') {
  ...
  legend('topleft', legend = info, lty = 1:5, cex = 1,
