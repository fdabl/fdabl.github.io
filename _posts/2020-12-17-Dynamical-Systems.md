...
The bulk of this blog post may be read as a preamble to Dablander, Pichler, Cika, & Bacilieri ([2020](https://psyarxiv.com/5wc28)), who provide an in-depth discussion of early warning signals and critical transitions. I recently gave a talk on this work and had the chutzpah to have it be [recorded](https://www.youtube.com/watch?v=055Ou_aqKUQ) (with slides available from [here](http://localhost:4000/assets/talks/Early-Warning.html#1)). The first thirty minutes or so cover part of what is explained here, in case you prefer frantic hand movements to the calming written word. But without any further ado, let's dive in!
