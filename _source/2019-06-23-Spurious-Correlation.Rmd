...
```{r, echo = FALSE, fig.align = 'center', fig.width = 9, fig.height = 7, message = FALSE, dpi=400}
library('latex2exp')
...
```{r, echo = FALSE, fig.align = 'center', fig.width = 9, fig.height = 7, dpi=400}
m <- lm(rw1 ~ rw2)
...
```{r, echo = FALSE, fig.align = 'center', fig.width = 12, fig.height = 10, dpi=400}
...
```{r, fig.align = 'center', fig.width = 12, fig.height = 6, echo = FALSE, dpi=400}
par(mfrow = c(1, 2))
